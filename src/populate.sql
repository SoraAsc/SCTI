...
-- Insert activities
INSERT INTO activities (spots, activity_type, room, speaker, topic, description, time, day, time_stamp)
VALUES
  (2, 'MC', 'INF-1', 'Annabel', 'Atividade exclusiva de duas vagas', 'Atividade para testar erro de atividade cheia', '08:00:00', 1, 1694169600),
  (20, 'MC', 'INF-2', 'Zoey', 'Elixir em ação', 'Como o elixir é usado em situações reais', '08:00:00', 1, 1694169600),
  (20, 'PL', 'Auditório 1', 'Guto', 'Trabalhando fora', 'Como conseguir trabalho fora e os passos que você deve tomar', '16:00:00', 1, 1694198400),
  (20, 'MC', 'INF-1', 'Emanuel', 'Nix e Sistemas Reproduziveis', 'Garantindo a funcionalidade de um projeto em diversos sistemas', '08:00:00', 2, 1694256000),
  (20, 'MC', 'INF-2', 'Sophia', 'Godot e Game Development', 'Introdução para game development usando a ferramenta Godot', '08:00:00', 2, 1694256000),
  (20, 'PL', 'Auditório 1', 'Vasilis', 'Trabalhando como contribuidor Open Source', 'Os altos e baixos de ser um contribuidor', '16:00:00', 2, 1694284800),
  (20, 'MC', 'INF-1', 'Filipe', 'Java para web devs', 'Usando java para desenvolver uma aplicação web', '08:00:00', 3, 1694342400),
  (20, 'PL', 'Auditório 1', 'May', 'Linguagens velhas em um mundo novo', 'Por que linguagens antigas commo PHP e Cobol ainda são usadas', '16:00:00', 3, 1694371200),
  (20, 'MC', 'INF-2', 'Luis Ramirez', 'Treinando IAs', 'Como usar Pytorch e Numpy prara treinar sua própria IA', '08:00:00', 4, 1694438400),
  (20, 'MC', 'INF-2', 'Riveira', 'Introdução a Engines', 'Como uma engine funciona e como criar a sua', '08:00:00', 5, 1694524800);
