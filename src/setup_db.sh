...
cmd="INSERT INTO users (email, name, uuid, verificationCode, isVerified, isAdmin, isPaid, sentqr) VALUES ('$Email', 'Voce', '623e4567-e89b-12d3-a456-426614174000', '623e4', TRUE, TRUE, TRUE, TRUE);"
